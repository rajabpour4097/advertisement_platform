...
$(document).ready(function (s) {
    ...
    function p(e) {
        ...
        if (e.parents(".st-headline").hasClass("type")) {
            ...
            e.parents(".st-headline").hasClass("clip")
                ? e.parents(".st-words-wrapper").animate({ width: "2px" }, c, function () {
                      m(e, i), u(i);
                  })
                : e.parents(".st-headline").hasClass("loading-bar")
                ? (e.parents(".st-words-wrapper").removeClass("is-loading"),
                  m(e, i),
                  setTimeout(function () {
                      p(i);
                  }, n),
                  setTimeout(function () {
                      e.parents(".st-words-wrapper").addClass("is-loading");
                  }, t))
                : (m(e, i),
                  setTimeout(function () {
                      p(i);
    ...
    function u(s, e) {
        s.parents(".st-headline").hasClass("type")
            ? (f(s.find("i").eq(0), s, !1, e), s.addClass("is-visible").removeClass("is-hidden"))
            : s.parents(".st-headline").hasClass("clip") &&
              s.parents(".st-words-wrapper").animate({ width: s.width() + 10 }, c, function () {
                  setTimeout(function () {
                      p(s);
                  }, h);
              });
    ...
    function f(s, e, i, n) {
        s.addClass("in").removeClass("out"),
            s.is(":last-child")
                ? (e.parents(".st-headline").hasClass("type") &&
                      setTimeout(function () {
                          e.parents(".st-words-wrapper").addClass("waiting");
                      }, 200),
                  i ||
                      setTimeout(function () {
                          p(e);
    ...
    s(".st-headline.letters")
        ...
        e.each(function () {
            ...
            if (e.hasClass("loading-bar"))
                (i = n),
                    setTimeout(function () {
                        e.find(".st-words-wrapper").addClass("is-loading");
                    }, t);
